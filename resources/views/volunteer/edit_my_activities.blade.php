...
<div class="d-flex justify-content-center">
    <div class="d-flex gap-3" style="max-width: 1000px; width: 100%;">
            ...
            <div class="flex-grow-1">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="image-preview-grid mt-4 mb-2">
                            ...
                            <div class="image-preview-item">
                                ...
                                <form action="{{ route('images.destroy', $image->img_id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <div class="remove-image" onclick="deleteImage(event, this.closest('form'));">×</div>
                                </form>
                            </div>
                            @endforeach
                        </div>                      
        ...
        <div class="btn-delete" style="text-align: right; margin-top: 20px;">
...
<script>
    ...
    function deleteImage(event, form) {
        event.preventDefault(); // ป้องกันการคลิกที่ฟอร์ม
        Swal.fire({
            title: 'Are you sure?',
            text: 'ลบรูปภาพนี้หรือไม่?',
            icon: 'warning',
