            ...
            <form action="{{ route('categories.update' , $category->cat_id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="cat_ismandatory" id="cat_ismandatory" class="form-select @error('cat_ismandatory') is-invalid @enderror" required>
                        <option value="1" {{ old('cat_ismandatory' , $category->cat_ismandatory) == '1' ? 'selected' : '' }}>บังคับ</option>
                        <option value="0" {{ old('cat_ismandatory' , $category->cat_ismandatory) == '0' ? 'selected' : '' }}>ไม่บังคับ</option>
                    </select>
