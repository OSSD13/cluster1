                        ...
                        @foreach ($categories as $index => $category)
                            <tr>
                                ...
                                <td class="text-center mt-4">
                                    <a href="{{route('categories.edit', $category->cat_id)}}" class="btn btn-lg btn-warning btn-sm" style="background-color: #FFB200; color: white; padding: 0.85px 15px; border-radius: 5px">แก้ไข</a>
                                    <!-- เพิ่ม ต้องหาเร้าต์เปิดรายละเอียด ไม่ใช่.edit-->
                                    <a href="{{ route('categories.edit', $category->cat_id) }}" class="btn btn-primary btn-sm" style="background-color: #2079FF; color: white; padding: 0.85px 15px; border-radius: 5px">รายละเอียด</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
