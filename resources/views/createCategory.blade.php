...
@section('content')
    <style>
        ...
        .radio-group {
            ...
            align-items: center;
            gap: 30px;
            /* ปรับระยะห่างระหว่าง radio button */
            flex-wrap: nowrap;
        }
        ...
        .radio-item {
            ...
            align-items: center;
            gap: 8px;
            /* ปรับระยะห่างระหว่าง radio และ label */
        }
    </style>
    ...
    <div class="container">
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <textarea id="description" placeholder="รายละเอียดของหมวดหมู่"></textarea>

            <label>ประเภทหมวดหมู่ <span style="color: red;">*</span></label>
            <div class="radio-group">
                <div class="radio-item" for="cat_ismandatory">
